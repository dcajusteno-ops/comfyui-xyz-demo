...
export function useXyz() {
  const [xyzTarget, setXyzTarget] = usePersistentState<TemplateKind>("comfyui_xyz_target", "default");
  
  const [xyzAxes, setXyzAxes] = usePersistentState<XyzAxis[]>("comfyui_xyz_axes", [
