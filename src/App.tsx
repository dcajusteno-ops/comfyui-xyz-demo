...
const generationTabs: Array<{ id: TabId; label: string; icon: typeof Wand2 }> = [
  { id: "default", label: "默认生图", icon: Wand2 },
  { id: "multi", label: "多人工作流", icon: UserRound },
  { id: "highres", label: "高清修复", icon: ImageUp },
];

const toolTabs: Array<{ id: TabId; label: string; icon: typeof Wand2 }> = [
...
const tabs: Array<{ id: TabId; label: string; icon: typeof Wand2 }> = [...generationTabs, ...toolTabs];
